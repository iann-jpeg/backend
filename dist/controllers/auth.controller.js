...
const auth_dto_1 = require("../config/auth.dto");
...
let AuthController = class AuthController {
    ...
    async setupInitialAdmin(body) {
        const { setupKey } = body, dto = __rest(body, ["setupKey"]);
        return this.authService.createInitialAdmin(dto, setupKey);
    }
    async promoteUser(userId, req) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "promoteUser", null);
__decorate([
